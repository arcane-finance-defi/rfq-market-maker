...
import { DEFAULT_ALEO_API_HOST, DEFAULT_EXPIRE_BLOCK_NUMBER, DEFAULT_SIGN_HOST } from './config.const'

config()

export const ValidConfig: IConfig = {
  ROUTER_WS_HOST: process.env.ROUTER_WS_HOST ?? '',
  SIGN_HOST: process.env.SIGN_HOST ?? DEFAULT_SIGN_HOST,
  ...
  ALEO_API_HOST: process.env.ALEO_API_HOST ?? DEFAULT_ALEO_API_HOST,
}
